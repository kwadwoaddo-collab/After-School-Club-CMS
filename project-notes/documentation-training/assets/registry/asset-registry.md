...
| `SS-D6-V012` | Creating a Confidential Safeguarding Record | Manager / DSL | `/dashboard/incidents` | 60s | P0 | **YES** | `CAPTURED — VIDEO QA VERIFIED` |
| `SS-D6-V013` | Setting up Agreed Monthly Family Tuition Fee | Owner/Manager | `/dashboard/students/[id]` | 60s | P1 | **YES** | `CAPTURED — VIDEO QA VERIFIED` |
| `SS-D6-V014` | Executing Monthly Invoicing Batch Run | Owner/Manager | `/dashboard/finance` | 60s | P1 | **YES** | `CAPTURED — VIDEO QA VERIFIED` |
