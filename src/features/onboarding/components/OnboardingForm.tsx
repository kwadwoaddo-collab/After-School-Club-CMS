                        ...
                        <div className="flex items-center gap-4">
                            {watchedLogo && (
                                <img
                                    src={watchedLogo}
                                    alt="Logo preview"
                                    className="w-12 h-12 rounded-lg object-contain bg-secondary/60 border border-outline-variant/10"
                                />
                            )}
                            <input
                                type="file"
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            <input
                                type="color"
                                {...register('brandColor')}
                                className="w-12 h-12 rounded-lg cursor-pointer border border-outline-variant/20 p-1 bg-secondary/60 shadow-sm"
                            />
