                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 pr-12 rounded-lg bg-white border border-blue-200 text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/50"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg bg-white border text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/50 ${confirmPassword && newPassword !== confirmPassword ? 'border-red-400' : 'border-blue-200'}`}
