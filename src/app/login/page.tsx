...
function LoginForm() {
  ...
  // Task 7: Google Sign-In state
  // 'mounted' gates the button until React hydration is complete, preventing
  // the "first-click does nothing" race condition where signIn() fires before
  // the browser has finished setting up the page.
  ...
  return (
    <>
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
        ...
        {mode === 'admin' && (
          <>
            {/* Task 7: Google button — disabled until hydration complete, with spinner + error feedback */}
            <button
              onClick={async () => {
                ...
                try {
                  ...
                  setGoogleError('Could not open the Google sign-in popup. Please try again or disable your popup blocker.');
            ...
            {googleError && (
              <p className="text-red-300 text-xs text-center mb-4">{googleError}</p>
            )}
