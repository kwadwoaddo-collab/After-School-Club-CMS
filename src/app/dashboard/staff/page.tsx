            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#1a1d23] rounded-2xl p-6 border border-[#424754]/15 shadow-[0_4px_24px_rgba(0,0,0,0.2)]">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-3xl font-bold text-[#e5e2e1] tracking-tight">{staffMembers.length}</p>
                        ...
                        <div className="p-6 flex-1">
                            <div className="flex flex-col gap-3">
                                {allCentres.map((centre) => (
                                    <div
                                        key={centre.id}
                                        className="p-5 bg-[#2a2a2a] rounded-2xl border border-[#424754]/15 flex items-center justify-between group hover:border-[#adc6ff]/30 transition-colors"
                                    >
                                        <div>
                                            <h3 className="font-bold text-[#e5e2e1] text-sm group-hover:text-[#adc6ff] transition-colors">{centre.name}</h3>
                                        ...
                                        <div className="w-8 h-8 rounded-lg bg-[#353535] flex items-center justify-center">
                                            <MapPin className="w-4 h-4 text-[#8c909f] group-hover:text-[#adc6ff] transition-colors" />
                                        </div>
                                    </div>
                                ))}
                            </div>
