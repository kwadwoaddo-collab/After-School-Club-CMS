...
export default function InviteStaffPage() {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            ...
            {/* Page Header */}
            <div>
                <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Invite Staff Member</h1>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                <div className="flex gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-blue-900 mb-1">Centre-Level Access</h3>
            ...
            {/* Invitation Form */}
            <form onSubmit={handleSubmit} className="glass-card rounded-[32px] overflow-hidden border border-slate-200">
