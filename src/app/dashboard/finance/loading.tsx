    ...
    return (
        <div className="space-y-8 animate-pulse">
                ...
                {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="glassmorphic-card rounded-2xl p-6 flex items-center gap-4">
                        ...
                        <div className="space-y-2 flex-1">
                            <div className="h-8 w-20 bg-card rounded-lg" />
            ...
            <div className="glassmorphic-card rounded-2xl overflow-hidden">
                <div className="h-14 bg-card/50 border-b border-outline-variant/10 px-6 flex items-center gap-3">
                    <div className="h-4 w-24 bg-card rounded" />
                    <div className="ml-auto h-9 w-28 bg-card rounded-xl" />
                </div>
                {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="flex items-center gap-4 px-6 py-5 border-b border-outline-variant/5">
                        ...
                        <div className="h-5 w-20 bg-card rounded-lg font-mono" />
                    </div>
                ))}
            </div>
        </div>
