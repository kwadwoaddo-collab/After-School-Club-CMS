        ...
        <div className="space-y-8 animate-pulse max-w-4xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="glassmorphic-card rounded-2xl p-6 space-y-4">
                        <div className="h-5 w-24 bg-surface-container-high rounded-lg" />
                        {[1, 2].map((i) => (
                            <div key={i} className="flex items-center gap-4 p-3 bg-surface-container-high/30 rounded-xl">
                ...
                <div className="space-y-6">
                    ...
                    <div className="glassmorphic-card rounded-2xl p-6 space-y-3">
                        <div className="h-5 w-28 bg-surface-container-high rounded-lg" />
                        <div className="h-10 bg-surface-container-high/50 rounded-xl" />
                        <div className="h-10 bg-surface-container-high/50 rounded-xl" />
                    </div>
                </div>
            </div>
