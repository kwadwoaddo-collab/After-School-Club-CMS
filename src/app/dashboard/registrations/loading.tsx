        ...
        <div className="space-y-8 animate-pulse">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                ...
                <div className="flex gap-3">
                    <div className="h-11 w-32 bg-surface-container-high rounded-2xl" />
            ...
            <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-2 bg-[#0d1117]/80 border-b border-white/5">
                <div className="flex items-center gap-2">
                    <div className="h-9 w-52 bg-surface-container-high rounded-xl" />
                    <div className="h-9 w-40 bg-surface-container-high rounded-xl" />
                </div>
            </div>
                    ...
                    <div key={i} className="glassmorphic-card rounded-[24px] p-6 min-h-[220px] flex flex-col justify-between">
                        <div className="space-y-3">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="h-3 w-40 bg-surface-container rounded-lg mt-2" />
                            </div>
                        </div>
                        <div className="flex items-center justify-between pt-4 border-t border-outline-variant/10">
                            <div className="h-4 w-20 bg-primary/20 rounded" />
                            <div className="h-8 w-36 bg-surface-container-high rounded-xl" />
                        </div>
                    </div>
                ))}
            </div>
