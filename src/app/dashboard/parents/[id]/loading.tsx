    ...
    return (
        <div className="space-y-8 animate-pulse">
            ...
            <div className="flex items-center gap-5">
                <div className="w-16 h-16 rounded-full bg-card flex-shrink-0" />
                <div className="space-y-2">
                    <div className="h-7 w-48 bg-card rounded-xl" />
                ...
                <div className="glassmorphic-card rounded-3xl p-6 space-y-5">
                    ...
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="flex items-center gap-3">
                            <div className="w-5 h-5 rounded bg-card flex-shrink-0" />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="glassmorphic-card rounded-2xl p-4 space-y-2">
                                <div className="h-7 w-10 bg-card rounded-lg" />
