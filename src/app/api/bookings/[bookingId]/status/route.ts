...
// Must match the bookingStatusEnum in schema.ts: booked | cancelled | rescheduled | attended | pending | signed_up
const statusSchema = z.object({
    status: z.enum(['booked', 'cancelled', 'rescheduled', 'attended', 'pending', 'signed_up']),
});
