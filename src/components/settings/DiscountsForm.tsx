    ...
    return (
        ...
        >
            <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl bg-secondary/60 border border-border flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`bg-secondary/60 border border-border rounded-xl text-sm text-foreground outline-none focus:border-primary transition-colors w-24 py-1.5 ${
...
export default function DiscountsForm() {
    ...
    return (
        <div className="max-w-2xl space-y-6 animate-in fade-in duration-500">
            ...
            {error && (
                <div className="bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3 text-sm text-red-600">
                    {error}
                </div>
            )}
            {success && (
