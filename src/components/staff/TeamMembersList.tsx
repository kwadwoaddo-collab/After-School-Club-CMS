    ...
    return (
        <div className="bg-[#1a1d23] rounded-[32px] overflow-hidden border border-[#424754]/15 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
            ...
            <div
                ...
                className="w-full px-8 py-6 border-b border-[#424754]/15 flex items-center justify-between hover:bg-white/5 transition-colors cursor-pointer select-none"
            >
                            ...
                            return (
                                <div key={member.id} className="p-4 sm:px-8 sm:py-6 hover:bg-[#202228] transition-colors">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                            ...
                                            <div>
                                                <div className="flex items-center justify-start gap-3 mb-1.5 flex-wrap">
                                                    ...
                                                    {member.id === currentUserId && (
                                                        <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#2a2a2a] text-[#8c909f] border border-[#424754]/30">You</span>
                                                    )}
                                                </div>
                                        ...
                                        {member.id !== currentUserId && (
                                            <Link href={`/dashboard/staff/${member.id}`} className="px-4 py-2 sm:py-2.5 text-xs font-bold text-[#adc6ff] bg-[#2a2a2a] hover:bg-[#353535] border border-[#424754]/15 rounded-xl transition-colors whitespace-nowrap self-start sm:self-auto active:scale-95 duration-100">
                                                Manage Access
                                            </Link>
                                        )}
                                    </div>
