...
export default function CopyRegistrationLink({ url }: { url: string }) {
    ...
    return (
        <button
            onClick={handleCopy}
            className="inline-flex items-center gap-1.5 px-4 py-2 bg-white border border-blue-300 text-blue-700 hover:bg-blue-50 text-sm font-medium rounded-xl transition-colors"
        >
            {copied ? (
                <>
