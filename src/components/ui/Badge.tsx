...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 px-2 py-0.5 rounded-sm text-xs font-medium border transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
